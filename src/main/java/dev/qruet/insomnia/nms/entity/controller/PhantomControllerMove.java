...
public class PhantomControllerMove extends ControllerMove {
    ...
    public void a() {
        ...
        float f = (float) (phantom.c.x - phantom.locX());
        float f1 = (float) (phantom.c.y - phantom.locY());
        float f2 = (float) (phantom.c.z - phantom.locZ());
        ...
        Vec3D vec3d = phantom.getMot();
        phantom.setMot(vec3d.e((new Vec3D(d3, d5, d4)).d(vec3d).a(0.2D)));
    }
